      ...
      @csrf
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            ...
            <input type="text" class="form-control" id="license_name" name="license_name" placeholder="Name">
          </div>
        </div>
        ...
        <div class="form-group row">
          <div class="col-sm-6">
            ...
            <input type="text" class="form-control" id="cid" name="cid" placeholder="CID Number">
          </div>
